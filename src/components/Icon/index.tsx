...
export const Facebook = (props: IconProps) => (
  <Base name="FacebookIcon" viewbox="0 0 21 20" {...props}>
    <path
      fill={props.fill}
      fillRule="evenodd"
      d="M11.007 20H1.341c-.615 0-1.114-.494-1.114-1.104V1.104C.227.494.726 0 1.341 0h17.954c.615 0 1.114.494 1.114 1.104v17.792c0 .61-.499 1.104-1.114 1.104h-5.143v-7.745h2.624l.393-3.019h-3.017V7.31c0-.873.245-1.469 1.51-1.469h1.613v-2.7c-.28-.037-1.237-.12-2.35-.12-2.326 0-3.918 1.407-3.918 3.99v2.226h-2.63v3.019h2.63V20z"
    />
  </Base>
)
