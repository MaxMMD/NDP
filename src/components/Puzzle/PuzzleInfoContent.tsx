...
function PuzzleInfoContent() {
  return (
    <div className="relative pb-8">
      ...
      <div className="border-t border-white border-b py-2 xl:flex justify-between">
        ...
        <div className="xl:flex">
          <span className="flex items-center">
            ...
            <ParagraphBase className="text-base font-light inline m-0 pl-2">
              Restoration Funded
            </ParagraphBase>
          </span>
          <span className="flex items-center xl:ml-4">
